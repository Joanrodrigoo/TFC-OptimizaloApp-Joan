...
const SubscribePage = () => {
  ...
  useEffect(() => {
    ...
    if (query.get("success")) {
      ...
      fetch(`${import.meta.env.VITE_API_URL || "https://optimizalo.app"}/api/auth/activate-subscription`, {
        method: "POST",
        credentials: "include",
      })
        .then(async (res) => {
          ...
          await fetch(`${import.meta.env.VITE_API_URL || "https://optimizalo.app"}/api/auth/me`, {
            credentials: "include",
          }).catch(() => {});
  ...
  const handleSubscribe = async () => {
    setLoading(true);
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL || "https://optimizalo.app"}/api/stripe/create-checkout-session`, {
        method: "POST",
        headers: {
