    ...
    <div className="flex flex-col min-h-screen">
      <header className="border-b">
        <div className="container flex items-center justify-between h-16 px-4">
           <h1 className="text-xl md:text-2xl font-bold text-gradient">AdOps AI</h1>
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto max-w-6xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register" className="w-full sm:w-auto">
                <Button size="lg" className="bg-adops-600 hover:bg-adops-700 px-8 py-4 md:py-6 w-full sm:w-auto">
                  Get Started for Free
                </Button>
              </Link>
              <Link to="/demo" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="px-8 py-4 md:py-6 w-full sm:w-auto">
        ...
        {/* Features Section */}
        <section className="py-12 md:py-16 bg-muted/30 px-4">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12">How AdOps AI Helps You</h2>
        ...
        {/* CTA Section */}
        <section className="py-12 md:py-20 px-4 bg-adops-600 text-white">
          <div className="container mx-auto max-w-4xl text-center">
             <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 leading-tight">
              Ready to optimize your Google Ads campaigns?
            </h2>
            <p className="text-base sm:text-lg md:text-xl opacity-90 mb-8 md:mb-10">
              Join thousands of marketers who are saving time and improving results with AdOps AI.
            </p>
            <Link to="/register">
              <Button size="lg" variant="secondary" className="px-8 py-4 md:py-6">
